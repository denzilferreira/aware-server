...
// --------------------------------------------------------------------
  ...
  */
	...
	/* Look for overload files in the /application/libraries folder */
	if (file_exists(BASEPATH.'../'.APPPATH.'libraries/MY_CI_DB_'.$CI->db->dbdriver.'_forge.php')) {
		require_once(BASEPATH.'../'.APPPATH.'libraries/MY_CI_DB_'.$CI->db->dbdriver.'_forge.php');
